...
const SUBMAP={
  '平台系統':['帳號密碼問題','定位異常','定位時間延遲','工作天數與實際不符','APP無法登入','登入失敗','網頁連不上','網頁速度慢','畫面顯示處理中/Loading','歷史影像資料無法下載','API異常','查無報表資料','報表資料異常','報表功能異常','進度追蹤','問題進度追蹤','報修進度追蹤','溫度異常','平台操作問題','權限問題','資料提供','其他'],
  MDVR:['鏡頭霧化、黑屏、藍屏、模糊不清','螢幕不會亮、黑屏、藍屏','螢幕顯示4分隔問題','DVR無法錄影','DVR錄影無影像檔','接頭問題','購料','報價單','進度追蹤','其他'],
  'GPS設備':['定位異常','GPS離線','新安裝','拆機','移機','溫度異常','進度追蹤','其他'],
  '行車視野':['螢幕不會亮、黑屏、藍屏','鏡頭霧化、黑屏、藍屏、模糊不清','鏡頭脫落','後鏡頭+無法錄影','DVR無法錄影','報價單','報表資料異常','進度追蹤','其他'],
  '雷達設備':['燈盒問題','A柱雷達','左右雷達','報價單','匯款單據','進度追蹤','其他'],
  '帳務問題':['發票問題','匯款單據','進度追蹤','其他'],
  '冷鏈':['溫度異常','GPS離線','進度追蹤','其他'],
  '溫度n/a':['感溫線(含頭)故障','溫度異常','進度追蹤','其他'],
  '其他':['進度追蹤','其他','轉接線','資料提供']
};
