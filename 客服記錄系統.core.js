...
const SUBMAP={
  '平台系統':['帳號密碼問題','定位異常','定位時間延遲','工作天數與實際不符','APP無法登入','登入失敗','網頁連不上','網頁速度慢','畫面顯示處理中/Loading','歷史影像資料無法下載','API異常','查無報表資料','報表資料異常','報表功能異常','問題進度追蹤','報修進度追蹤','溫度異常','平台操作問題','權限問題','資料提供','其他'],
